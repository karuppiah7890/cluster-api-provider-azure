...
var diskSpec1 = DiskSpec{
	Name: "my-disk-1",
}

var diskSpec2 = DiskSpec{
	Name: "my-disk-2",
}

var fakeDiskSpecs = []azure.ResourceSpecGetter{
	&diskSpec1,
	&diskSpec2,
}
...
func TestDeleteDisk(t *testing.T) {
	testcases := []struct {
		...
		// TODO(karuppiah7890): Add more tests, uncomment below tests and make them pass
		// {
